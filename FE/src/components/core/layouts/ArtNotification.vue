...
<script setup lang="ts">
  ...
  const useNotificationData = () => {
    const noticeList = ref<NoticeItem[]>([
      ...
      {
        title: 'Leng Yue Dada sent you a message',
        time: '2024-4-21 8:05',
        type: 'message'
      },
      {
        title: 'Xiao Feizhu followed you',
        time: '2020-3-17 21:12',
        type: 'collection'
      },
      {
        title: 'Added user guide',
        time: '2024-02-14 0:20',
        type: 'notice'
      },
      {
        title: 'Xiao Feizhu sent you an email',
        time: '2024-1-20 0:15',
        type: 'email'
      },
      {
        title: 'Menu mock uses local real data',
    ...
    const msgList = ref<MessageItem[]>([
      {
        title: 'Chi Bupang followed you',
        time: '2021-2-26 23:50',
        avatar: avatar1
      },
      {
        title: 'Tang Buku followed you',
        time: '2021-2-21 8:05',
        avatar: avatar2
      },
      {
      ...
      {
        title: 'He Xiahe followed you',
        time: '2021-01-14 0:20',
        avatar: avatar4
      },
      {
        title: 'Suisuinian followed you',
        time: '2020-12-20 0:15',
        avatar: avatar5
      },
      {
        title: 'Leng Yue Dada followed you',
