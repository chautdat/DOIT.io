  ...
  <div class="layout-lock-screen">
    ...
    >
      <div class="p-5 text-center select-none">
        ...
        <h1 class="m-0 mb-5 text-3xl font-semibold text-danger">System locked</h1>
        <p class="max-w-125 m-0 text-lg leading-relaxed text-white">
          Developer tools are open<br />
          For security, please close them before continuing
        </p>
    ...
    <div v-if="!isLock">
      <ElDialog v-model="visible" :width="370" :show-close="false" @open="handleDialogOpen">
        <div class="flex-c flex-col">
          <img class="w-16 h-16 rounded-full" src="@imgs/user/avatar.webp" alt="User avatar" />
    ...
    <div v-else class="unlock-content">
      <div class="flex-c flex-col w-80">
        <img class="w-16 h-16 mt-5 rounded-full" src="@imgs/user/avatar.webp" alt="User avatar" />
