<template>
  <div class="cutter-container">
    <div class="cutter-component">
      ...
      >
        <template #choose>
          <ElButton type="primary" plain v-ripple>Choose image</ElButton>
        </template>
        <template #cancel>
          <ElButton type="danger" plain v-ripple>Clear</ElButton>
        </template>
        <template #confirm>
          <div></div>
        </template>
    ...
    <div v-if="showPreview" class="preview-container">
      ...
      >
        <img class="preview-img" :src="temImgPath" alt="Preview image" v-if="temImgPath" />
      </div>
      <ElButton class="download-btn" @click="downloadImg" :disabled="!temImgPath" v-ripple
        >Download image</ElButton
      >
    </div>
  </div>
</template>
